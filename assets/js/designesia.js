...
jQuery(document).ready(function () {
  ...
  if (show_preloader == 1) {
    jQuery(
      "header,.v-text,#controls,#nextslide,#prevslide,#subheader h1,#subheader h4,#slidecaption,#section-main,.float-text"
    ).addClass("wow");
    jQuery("body").jpreLoader(
      {
        ...
        splashFunction: function () {
          ...
          jQuery("#controls,#nextslide,#prevslide").attr(
            "data-wow-delay",
            ".5s"
          );
  ...
  jQuery(window).on("load", function () {
    ...
    $(".de-simple-tab li").click(function () {
      ...
      $(this)
        .parent()
        .parent()
        .find(".de-simple-tab-content > div:eq(" + indexer + ")")
        .fadeIn(); //uses whatever index the link has to open the corresponding box
    });
  ...
  var incrementPlus = buttonPlus.click(function () {
    var $n = $(this).parent().find(".f-input-number");
